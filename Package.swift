...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			...
			url: "https://cdn.attractions.io/frameworks/maplayr-ios/v0.16.0-indoorPositioning.5/MapLayrInternal.xcframework.zip",
			checksum: "ae9dee47eef87f5db099494f959ca487497da7e977ceedc88c8a4a42e9b7dfd4"
		),
		.binaryTarget(
			name: "MapGeometry",
