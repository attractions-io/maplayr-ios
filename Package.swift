...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			...
			url: "https://cdn.attractions.io/frameworks/maplayr-ios/v0.11/MapLayrInternal.xcframework.zip",
			checksum: "8127ae10ebb29753fd5e681437dcd47aec1659dc809e3bffb339efef4d5ff455"
		),
		.binaryTarget(
			name: "MapGeometry",
