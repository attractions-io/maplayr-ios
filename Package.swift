...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			...
			url: "https://cdn.attractions.io/frameworks/maplayr-ios/v0.16.0-indoorPositioning.7/MapLayrInternal.xcframework.zip",
			checksum: "77105351adce460777f242274658c384308eb91a73c2bd1c3780997584cc3cdf"
		),
		.binaryTarget(
			name: "MapGeometry",
