...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			...
			url: "https://cdn.attractions.io/frameworks/maplayr-ios/v0.9/MapLayrInternal.xcframework.zip",
			checksum: "2792fc38ed169ad55de9e2edf21a791b10aea78f57de357e651aefdc52ad1fdd"),
		.binaryTarget(
			name: "MapGeometry",
