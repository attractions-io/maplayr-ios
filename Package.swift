...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			...
			url: "https://cdn.attractions.io/frameworks/maplayr-ios/v0.16.0-indoorPositioning.2/MapLayrInternal.xcframework.zip",
			checksum: "d8e64c84f139b559c7812d263535059a23aded9c1926a2b1479bd778213da920"
		),
		.binaryTarget(
			name: "MapGeometry",
