...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			...
			url: "https://cdn.attractions.io/frameworks/maplayr-ios/v0.10/MapLayrInternal.xcframework.zip",
			checksum: "393e547ed4740af44c7cbaeebff9e7da4243dd7ee46973291906e57a53353b43"
		),
		.binaryTarget(
			name: "MapGeometry",
