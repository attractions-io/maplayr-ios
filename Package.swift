...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			...
			url: "https://cdn.attractions.io/frameworks/maplayr-ios/v0.12/MapLayrInternal.xcframework.zip",
			checksum: "1e1252f948426e7e94337843578a1b039533817b15256a6fb78eaf5a747c0a79"
		),
		.binaryTarget(
			name: "MapGeometry",
