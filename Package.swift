...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			...
			url: "https://cdn.attractions.io/frameworks/maplayr-ios/v0.16.0-indoorPositioning.6/MapLayrInternal.xcframework.zip",
			checksum: "2814f7d3e98e703c52bffd152c5428759e5ee170302a0cff139dae9ddc3a5862"
		),
		.binaryTarget(
			name: "MapGeometry",
