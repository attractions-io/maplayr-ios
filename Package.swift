...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			...
			url: "https://cdn.attractions.io/frameworks/maplayr-ios/v0.16.0-indoorPositioning.4/MapLayrInternal.xcframework.zip",
			checksum: "f8030ffc3a7214ba3f17120718007959a8e1a3cec42b8c3ecfd904aa8a939f0b"
		),
		.binaryTarget(
			name: "MapGeometry",
