Pod::Spec.new do |spec|
	spec.name                = "MapLayr"
	spec.version             = "0.16.0-indoorPositioning.5"
	...
	spec.prepare_command     = <<-CMD
	                                ...
	                                curl -L -o MapLayrInternal.xcframework.zip "https://cdn.attractions.io/frameworks/maplayr-ios/v0.16.0-indoorPositioning.5/MapLayrInternal.xcframework.zip"
