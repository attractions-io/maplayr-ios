Pod::Spec.new do |spec|
	spec.name                = "MapLayr"
	spec.version             = "0.16.0-indoorPositioning.4"
	...
	spec.prepare_command     = <<-CMD
	                                ...
	                                curl -L -o MapLayrInternal.xcframework.zip "https://cdn.attractions.io/frameworks/maplayr-ios/v0.16.0-indoorPositioning.4/MapLayrInternal.xcframework.zip"
